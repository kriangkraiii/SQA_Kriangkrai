...
class TestWithTestSuite(unittest.TestCase):
    def setUp(self):
    ...
    def make_suite(self):
        ...
        suite.addTest(TestWithTestSuite("test_add_two_number"))
        suite.addTest(TestWithTestSuite("test_subtract_two_number"))
        suite.addTest(TestWithTestSuite("test_multiply_two_number"))
        return suite

if __name__ == '__main__':
#    unittest.main()
    runner = unittest.TextTestRunner()
    test_suite = TestWithTestSuite()
